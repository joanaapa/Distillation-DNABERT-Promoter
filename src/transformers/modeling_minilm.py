    ...
    def forward(self, hidden_states, attention_mask, is_student):
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if i == len(self.layer) - 1 or is_student:
                ...
                all_key_layers.append(key_layer)
                all_query_layers.append(query_layer)
...
class MiniLMForPreTraining(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
                labels=None, next_sentence_label=None, is_student=False):
        ...
        if labels is not None:
            ...
            outs = {'loss':masked_lm_loss, 'logits':prediction_scores}
            return outs
